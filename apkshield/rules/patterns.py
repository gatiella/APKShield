...
# ─────────────────────────────────────────────────────────────────────────────
SDK_FINGERPRINTS = {
    # (package_fragment, display_name, privacy_notes)
    "com.facebook.":            ("Facebook SDK",          "Collects device ID, IDFA, and behavioural data."),
    "com.appsflyer.":           ("AppsFlyer",             "Mobile attribution SDK — collects device identifiers."),
    "com.adjust.sdk":           ("Adjust",                "Mobile attribution SDK — collects install/event data."),
    ...
    "com.google.firebase.":     ("Firebase",              "Google analytics, crash reporting, push."),
    ...
    "com.mopub.":               ("MoPub (deprecated)",    "Ad network — deprecated since 2022."),
    "com.unity3d.ads":          ("Unity Ads",             "Ad SDK for games."),
    "com.ironsource.":          ("IronSource",            "Ad mediation SDK."),
    "com.google.ads.":          ("Google Mobile Ads",     "AdMob SDK — collects GAID and interests."),
    "com.chartboost.":          ("Chartboost",            "Game ad SDK."),
    "net.hockeyapp.":           ("HockeyApp (legacy)",    "Deprecated — migrate to App Center or Firebase."),
    "com.microsoft.appcenter.": ("Microsoft App Center",  "Crash and analytics SDK."),
}
